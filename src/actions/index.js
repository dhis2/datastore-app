 ...
 * @return {object}           Action
 */
export function receiveHistory(namespace, key, history) {
    return {
...
/**
 * receiveNamespaceHistory - Request history of namespace
 *
 * @param  {string} namespace Namespace of requested history
 * @param  {array} history    History of namespace
 * @return {object}           Action
 */
export function receiveNamespaceHistory(namespace, history) {
    return {
